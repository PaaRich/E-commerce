...
const HeroHeader = () => {
  return (
    <div className="container mx-auto relative lg:h-[90dvh]">
      <div className="flex items-center gap-x-5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
        <div className="lg:w-3/4 lg:flex lg:items-center bg-[rgb(245,245,245)] lg:h-[400px] px-10 rounded-lg shadow-lg">
          <div className="lg:h-[60%] lg:flex lg:flex-col lg:justify-between">
            <h1 className="text-7xl font-semibold">FarmGhana</h1>
        ...
        <div className="lg:w-1/4 lg:h-[400px] bg-[#02f879e0] relative lg:flex lg:items-center rounded-lg shadow-lg">
